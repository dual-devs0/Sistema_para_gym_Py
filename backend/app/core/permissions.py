...
ROLE_PERMISSIONS: dict[str, set[str]] = {
    "owner": {
        ...
        Perm.PLAN_READ, Perm.PLAN_CREATE, Perm.PLAN_UPDATE, Perm.PLAN_DELETE,
        Perm.MEMBERSHIP_READ, Perm.MEMBERSHIP_ASSIGN, Perm.MEMBERSHIP_CANCEL, Perm.MEMBERSHIP_RENEW,
        Perm.ATTENDANCE_READ, Perm.ATTENDANCE_CHECKIN, Perm.ATTENDANCE_CHECKOUT,
        Perm.USER_READ, Perm.USER_CREATE, Perm.USER_UPDATE, Perm.USER_DELETE,
        Perm.GYM_SETTINGS_READ, Perm.GYM_SETTINGS_UPDATE,
        Perm.DASHBOARD_VIEW,
        Perm.AUDIT_VIEW,
    },
    "admin": {
        ...
        Perm.MEMBERSHIP_READ, Perm.MEMBERSHIP_ASSIGN, Perm.MEMBERSHIP_CANCEL, Perm.MEMBERSHIP_RENEW,
        Perm.ATTENDANCE_READ, Perm.ATTENDANCE_CHECKIN, Perm.ATTENDANCE_CHECKOUT,
        Perm.USER_READ, Perm.USER_CREATE, Perm.USER_UPDATE,
        Perm.GYM_SETTINGS_READ, Perm.GYM_SETTINGS_UPDATE,
        Perm.DASHBOARD_VIEW,
    },
    "trainer": {
        Perm.MEMBER_READ, Perm.MEMBER_CREATE, Perm.MEMBER_UPDATE,
        Perm.PLAN_READ,
    ...
    "receptionist": {
        Perm.MEMBER_READ, Perm.MEMBER_CREATE, Perm.MEMBER_UPDATE,
        Perm.PAYMENT_READ, Perm.PAYMENT_CREATE,
        Perm.PLAN_READ,
        Perm.MEMBERSHIP_READ, Perm.MEMBERSHIP_ASSIGN, Perm.MEMBERSHIP_RENEW,
        Perm.ATTENDANCE_READ, Perm.ATTENDANCE_CHECKIN, Perm.ATTENDANCE_CHECKOUT,
        Perm.USER_READ,
    },
}
